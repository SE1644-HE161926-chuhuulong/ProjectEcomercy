...
public class resetPassword extends HttpServlet {
    ...
    private static boolean isValidToken(String token) {
        try {
            ...
            return TokenGenerator.validCheck(token, new UserModel().getUserByUsername(name).getPassword());
        } catch (Exception e) {
            return false;
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("account/reset_pass.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String username = TokenGenerator.decrypt(token).getString("username");
            ...
            response.sendRedirect("error_pages/500.jsp");
        }
