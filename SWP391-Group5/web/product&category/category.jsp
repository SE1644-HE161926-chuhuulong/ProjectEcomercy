                    ...
                    <div class="sidebar-categories">
                        ...
                        <ul class="main-categories">
                            <c:forEach items="${requestScope.listC}" var="listC">
                                <li class="main-nav-list"><a data-toggle="collapse" href="#category${listC.cateId}" aria-expanded="false" aria-controls="category${listC.cateId}"><span
                                            class="lnr lnr-arrow-right"></span>${listC.cateName}</a>
                                    <ul class="collapse" id="category${listC.cateId}" data-toggle="collapse" aria-expanded="false" aria-controls="category${listC.cateId}">
                                        <c:forEach items="${listC.subCategory}" var="sublistC">
                                            <li class="main-nav-list child"><a href="${pageContext.request.contextPath}/productshopdetail?cateId=${sublistC.cateId}">${sublistC.cateName}</a></li>
                                            </c:forEach>
                                    </ul>
                                </li>
                            </c:forEach>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="single-product">
                                        <div class="img-product">
                                            <a href="${pageContext.request.contextPath}/productDetail?productId=${listP.productId}">
                                                <img style="height: 100%" class="img-fluid" src="${listP.image}" alt="Error">
                                            </a>
                                        </div>
                                        <div class="product-details">
                                            <a href="${pageContext.request.contextPath}/productDetail?productId=${listP.productId}"><h6 style="font-family: monospace;height: 40px"">${listP.productName}</h6></a>
                                            <div class="price">
                                            ...
                                            <div class="prd-bottom">
                                                ...
                                                <a href="${pageContext.request.contextPath}/productDetail?productId=${listP.productId}" class="social-info">
